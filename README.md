...
For feature extraction using HistGen feature extractor, Uni or Uni2 use the respective files in [Feature extraction](/HistGen/CLAM/) using clam conda environment and for CONCHv1.5 use the [Feature extraction](/HistGen4TITAN/CONCH%CLAM/extract_features_calling_script.sh)
